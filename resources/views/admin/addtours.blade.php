                ...
                <div class="col-9 mx-auto">
                    <form method="POST" action="{{ route('tour.store')}} " enctype="multipart/form-data">
                        ...
                        <div class="row">
                         ...
                         <div class="col-4">
                                <div class="form-group">
                                    <label for="name">tour type</label>
                        ...
                        <div class="row">
                            <div class="col-9">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="depart" name="place_d" autofocus >
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-9">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="place_a" autofocus >
                                </div>
                            </div>
                        </div>
