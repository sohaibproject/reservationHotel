  ...
  @include('admin.includs.alerts.success')
    <div class="container-fluid ">
        <div class=" d-flex justify-content-between flex-wrap flex-md-nowrap         align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2 m-2">Edit Reservation</h1>
             </div>
             @if(count($errors) > 0)
                    ...
                    <form method="POST" action="{{ route('reservation.update',$reservation->id)}} " enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-9">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" value="{{$reservation->name}}" name="name" autofocus >
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-9">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="name"value="{{$reservation->phone}}" name="phone" autofocus >
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-9">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="name" value="{{$reservation->email}}" name="email" autofocus >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="summernote" name="note" cols="98" rows="7">{{$reservation->notes}}</textarea>
                            </div>
                            </div>
                        </div>
