...
<head>
  ...
  <title>Detail hotels {{$hotel->name}}</title>
...
<body>
  ...
  <section class="w3l-about-breadcrumb text-left">
    <div class="breadcrumb-bg breadcrumb-bg-about py-sm-5 py-4">
      <div class="container py-2">
        <h2 class="title">Detail hotels {{$hotel->name}}</h2>
  ...
  <section class="w3l-content-6 py-5 " id="aboutus">
    <div class="container py-lg-5">
            ...
            <h3 class="hny-title mb-md-5 mb-4">{{$hotel->name}} </h3>
        
      <div class="row">
        <div class="col-lg-6 content-6-left pr-lg-5 subject-card-header p-4">
          <img src="{{URL::asset('images/hotels/'.$hotel->photo)}}" class="img-fluid" alt="">
        </div>
        <div class="col-lg-6 content-6-right mt-lg-0 mt-4">
          ...
          <section class="w3l-grids1">
            <div class="hny-three-grids py-5">
              <div class="container py-lg-5">
                 <h3 class="hny-title mb-md-5 mb-4">our  room in {{$hotel->name}} </h3>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4 col-sm-6 mt-0 grids5-info">
                        <img src="{{URL::asset('images/rooms/'.$room->photo)}}" style="max-height:200px;min-height: 200px " class="img-fluid" alt="">
          ...
          <section class="w3l-grids1">
            <div class="hny-three-grids py-5">
              <div class="container py-lg-5">
                 <h3 class="hny-title mb-md-5 mb-4">related  hotels in {{$hotel->willaya->name}} </h3>
                <div class="row">
                    @if ($hotels)
                      @foreach ($hotels as $hotels)
                      @if ($hotels->id != $hotel->id)
                    {{-- $place[0]->photos[0]->file_name --}}
                   
                  <div class="col-md-4 col-sm-6 mt-0 grids5-info">
                    <a href="{{route('details.hotels',$hotels->id)}}"><img src="{{URL::asset('images/hotels/'.$hotels->photo)}}" style="max-height:200px;min-height: 200px " class="img-fluid" alt=""></a>
                    <h5> {{$hotels->willaya->name}}</h5>
                    <h4><a href="{{route('details.hotels',$hotels->id)}}">{{$hotels->name}}</a></h4>
                    @for($i = 0; $i < 5; $i++)
                    @if($i < $hotels->rating)
         ...
         <section class="w3l-grids1">
           <div class="hny-three-grids py-5">
             <div class="container py-lg-5">
                <h3 class="hny-title mb-md-5 mb-4">related places in {{$hotel->willaya->name}} </h3>
               <div class="row">
                   @if ($places)
                 ...
                 <div class="col-md-4 col-sm-6 mt-0 grids5-info">
                   ...
                   <h5> {{$places->willaya->name}}</h5>
                   <h4><a href="{{route('details.places',$places->id)}}">{{$places->name}}</a></h4>
