      ...
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center text-center">
          <div class="col-md-10 text-center" data-aos="fade-up">
            <h1 class="heading">Make Your Reservation Easy</h1>
          </div>
        </div>
      </div>
    ...
    <section class="section bg-light" id="next">
      ...
      <div class="container">
        ...
        <div class="site-block-half d-flex bg-white" data-aos="fade-up" data-aos-delay="100">
            <a href="#" class="image d-block bg-image" style="background-image:url({{url('images/rooms/'.$room->photo)}});"></a>
            <div class="text">
             ...
             you can make your reservation from this inputs bellow
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-7" data-aos="fade-up" data-aos-delay="100">
              ...
              <form action="{{ url('/makeReservation')}}" method="POST" class="bg-white p-md-5 p-4 mb-5 border">
                @csrf
                {{-- {{ method_field('PUT') }} --}}
                <div class="row">
                ...
                <div class="row">
                  <div class="col-md-6 form-group">
                    ...
                    <input type="text" name="CheckIn_date" required id="checkin_date" class="form-control">
                  </div>
                  <div class="col-md-6 form-group">
                    <label class="text-black font-weight-bold" for="checkout_date">Date Check Our</label>
                    <input type="text" name="CheckOut_date" required  id="checkout_date" class="form-control">
                  </div>
                </div>
                ...
                <div class="row mb-4">
                  <div class="col-md-12 form-group">
                    ...
                    <textarea name="notes" required  id="message" class="form-control " cols="30" rows="8"></textarea>
                  </div>
                </div>
