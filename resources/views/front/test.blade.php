  ...
  <body>
    ...
    <header class="site-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-4 site-logo" data-aos="fade"><a href="index.html"><em>My Hotel</em></a></div>
          <div class="col-8">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-7 ml-auto order-lg-2" data-aos="fade-up">
            <img src="{{  URL::asset('front/img/about_feature_image.png')}}" alt="Image" class="img-fluid">
          </div>
    ...
    <section class="section bg-light">
      ...
      <div class="container">
        ...
        <div class="site-block-half d-flex bg-white" data-aos="fade-up" data-aos-delay="100">
          <a href="#" class="image d-block bg-image" style="background-image:url({{url('front/img/img_1.jpg')}});"></a>
          <div class="text">
